...
class JoyStick{
	...
	tap(evt){
		...
		const joystick = this;
		if ('ontouchstart' in window){
            // document.addEventListener('touchmove', (e) => { e.preventDefault(); joystick.move(e); }, {passive: false});
            // document.addEventListener('touchend', (e) => { e.preventDefault(); joystick.up(e); }, {passive: false});
